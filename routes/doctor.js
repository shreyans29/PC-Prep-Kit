...
const generateSymptomsReply = function(malariaRisk, done) {
    ...
    if (malariaRisk > 6) {
        ...
        reply = 'There are chances of you being infected with malaria. Malaria can be a threat to life, It is always recommneded you vist your doctor if you have any doubts.';
    } else {
        reply = 'It is less likely that you are infected with malaria. However it is always recommneded you visit a doctor since Malaria can turn out to be life threatening.';
    }
    done(reply);
}
